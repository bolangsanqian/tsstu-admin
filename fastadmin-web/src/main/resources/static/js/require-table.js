define(['jquery', 'bootstrap', 'moment', 'moment/locale/zh-cn', 'bootstrap-table', 'bootstrap-table-lang', 'bootstrap-table-export', 'bootstrap-table-commonsearch', 'bootstrap-table-template'], function ($, undefined, Moment) {
    var Table = {
        ...
        defaults: {
            url: '',
            totalField: 'total', //MY UPDATE
            dataField: 'list', //MY UPDATE
            ...
            queryParams: function (params) {
                var queryParams = {
                    ...
                    pageNum: ((params.offset % params.limit) > 0 ? (params.offset / params.limit + 1) : (params.offset / params.limit)) + 1,
                };
                return queryParams;
            }
            //MY UPDATE END
            ...
            events: {
                operate: {
                    'click .btn-editone': function (e, value, row, index) {
                        ...
                        var url = options.extend.edit_url + "?id=" + row.ids;
                        Fast.api.open(url, __('Edit'), $(this).data() || {});
                    },

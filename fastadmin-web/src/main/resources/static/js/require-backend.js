...
//        'selectpage': ['css!../libs/fastadmin-selectpage/selectpage.css'],
    ...
    //MY UPDATE ||| baseUrl: requirejs.s.contexts._.config.config.site.cdnurl + '/assets/js/', //资源基础路径
    baseUrl: '/js/', //资源基础路径
    map: {
        '*': {
...
require(['jquery', 'bootstrap'], function ($, undefined) {
    ...
    // 配置语言包的路径
    var paths = {};
    //MY UPDATE |||| paths['lang'] = Config.moduleurl + '/ajax/lang?callback=define&controllername=' + Config.controllername;
    paths['lang'] = '/ajax/lang?callback=define&controllername=' + Config.controllername;
    // 避免目录冲突
